...
if (isset($_POST["login"]))
{
	...
	if ($match_count) 
	{
		// 將username欄位的值存入SESSION
		$_SESSION["username"] = $_POST["username"];
		// 將password欄位的值存入SESSION
		...
		header("Location: http://localhost/ex25-8-1.php?user=" . $_POST["username"]);
	}
	else
	{
		// 重新載入本網頁
...
<title>ex25-8</title>
<link href="ex25-8.css" rel="stylesheet" type="text/css" />
</head>
<body>
<table class="style12">
  <tr>

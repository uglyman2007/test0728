...
<title>ex25-7</title>
<link href="ex25-7.css" rel="stylesheet" type="text/css" />
</head>
<body>
<form method="post" name="form1" id="form1">
  <table class="style5">
    ...
    <tr>
      <td align="center" valign="middle" class="style6">意見
	    <span class="style8">★</span>
	  </td>
      <td class="style7">
	    <textarea name="comment" cols="60" rows="8" id="comment">
		</textarea>
	  </td>
    </tr>
    <tr>
...
if (isset($_POST["insert"]))
{
	...
	// 將表單資料存入ch25資料庫的postcomment資料表內
	$query = "INSERT INTO postcomment (subject, name, email, comment, postdate) VALUES ('" . 
		$_POST["subject"] . "', '" . $_POST["name"] . "', '" . $_POST["email"] . "', '" . $_POST["comment"] . 
		"', '" . $_POST["postdate"] . "')";
